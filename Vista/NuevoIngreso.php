...
<style>
    ...
    #plataformaSeleccionada,#clienteSeleccionado{
        width: 100%;
    }
    #cabecera{
        text-align: center;
        ...
        <div class='container' style='width:50%;'>
            ...
            <form id="formNuevoIngreso" class="margenSuperior" method="post" action='#'>
                ...
                <div class="input-group mb-6 margenSuperior">
                    ...
                    <select id="clienteSeleccionado" name="id_cliente" class="fw-bold col-6">
                ...
                <div class="input-group mb-3 margenSuperior">
                    ...
                    <input type="number" min="1" max="4" name="huespedes" class="form-control" id="huespedes" required placeholder="Número de huespedes" aria-label="Username" aria-describedby="basic-addon1">
                </div>
                ...
                <div class="row mt-3">
                        <div class="col-3 mx-auto">
                            <input class="btn btn-primary mx-auto" type="submit" value="SALIR" name="salir" id="salir">
                        </div>
                        <div class="col-3 mx-auto">
                            <input class="btn btn-warning mx-auto" id="enviar" type="submit" value="ENVIAR" name="enviarIngreso">
                        </div>
                    </div>
